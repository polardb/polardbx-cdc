...
public class RemoteCleanBarrier implements ICleanerBarrier {
    ...
    public RemoteCleanBarrier(String group, String stream) {
    ...
    public boolean canClean(String binlogName) {
        Optional<BinlogOssRecord> recordOptional = ossRecordMapper.selectOne(s -> s.
            where(BinlogOssRecordDynamicSqlSupport.groupId, SqlBuilder.isEqualTo(group)).
            and(BinlogOssRecordDynamicSqlSupport.streamId, SqlBuilder.isEqualTo(stream)).
            and(BinlogOssRecordDynamicSqlSupport.binlogFile, SqlBuilder.isEqualTo(binlogName)));
