 ...
 */
@Slf4j
public class ReconCoordinatorTest {
    @Before
    public void before() {
    ...
    @Test
    public void testReconCoordinator() {
    ...
    private ValidationContext getContext() {
        ...
        try {
            ...
            DruidDataSource srcDs =
                DataSourceUtil.createDruidMySqlDataSource("192.169.1.1",
                    3306,
                    "mytest",
                    "mytest",
                    "mytest",
            ...
            String srcPhyTable = "sync_delete_data_log";
            ...
            String dstTable = "SYNC_DELETE_DATA_LOG";
