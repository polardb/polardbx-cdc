 ...
 *
 */
package com.aliyun.polardbx.binlog.extractor.filter.meta;
...
public enum SqlKind {
    ...
    /**
     * DSql add {@code  GROUP_CONCAT} function.
     */
    GROUP_CONCAT,
    /**
     * TDDL ADD {@code  BIT_OR}
     */
    BIT_OR,
    /**
    ...
    MOVE_DATABASE, SHOW_MOVE_DATABASE,
     ...
     */
    public static final EnumSet<SqlKind> AGGREGATE = EnumSet.of(COUNT,
        SUM,
        SUM0,
        MIN,
        MAX,
     ...
     */
    public static final EnumSet<SqlKind> DML = EnumSet.of(INSERT,
        REPLACE,
        DELETE,
        UPDATE,
        MERGE,
    ...
    public static final EnumSet<SqlKind> CHECK_ALTER_WITH_GSI = concat(ALTER_ADD_INDEX,
        ALTER_ALTER_COLUMN,
        EnumSet.of(ENABLE_KEYS, DROP_PRIMARY_KEY));

    public static final EnumSet<SqlKind> DDL = concat(ALTER_ALTER_COLUMN,
        ALTER_ADD_INDEX,
        EnumSet.of(COMMIT,
            ROLLBACK,
            ALTER_SESSION,
    ...
    public static final EnumSet<SqlKind> SUPPORT_DDL = EnumSet.of(CREATE_TABLE,
        ALTER_TABLE,
        DROP_TABLE,
        CREATE_VIEW,
        ALTER_VIEW,
    ...
    public static final EnumSet<SqlKind> SUPPORT_SHADOW_DDL = EnumSet.of(CREATE_TABLE,
        ALTER_TABLE,
        DROP_TABLE,
        CREATE_INDEX,
        ALTER_INDEX,
    ...
    public static final EnumSet<SqlKind> SEQUENCE_DDL = EnumSet.of(CREATE_SEQUENCE,
        ALTER_SEQUENCE,
        DROP_SEQUENCE,
        RENAME_SEQUENCE);
     ...
     * {@link #EXPLICIT_TABLE}.
     */
    public static final EnumSet<SqlKind> QUERY = EnumSet.of(SELECT,
        UNION,
        INTERSECT,
        EXCEPT,
        VALUES,
     ...
     */
    public static final Set<SqlKind> EXPRESSION = EnumSet.complementOf(concat(EnumSet.of(AS,
        ARGUMENT_ASSIGNMENT,
        DEFAULT,
        RUNNING,
        FINAL,
        ...
        WITH_ITEM,
        SKIP_TO_FIRST,
        SKIP_TO_LAST), AGGREGATE, DML, DDL, DAL));
     ...
     */
    public static final Set<SqlKind> COMPARISON = EnumSet.of(IN,
        EQUALS,
        NOT_EQUALS,
        LESS_THAN,
        GREATER_THAN,
     ...
     */
    public static final Set<SqlKind> BINARY_COMPARISON = EnumSet.of(EQUALS,
        NOT_EQUALS,
        GREATER_THAN,
        GREATER_THAN_OR_EQUAL,
        LESS_THAN,
