...
public class ReformatTest {
    ...
    public void generateData() throws Exception {
        ...
        fieldList.add(MakeFieldFactory.makeField("JSON", "{\"id\": 1,\"name\": \"muscleape\"}", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("JSON", null, "utf8", true));
        fieldList.add(MakeFieldFactory.makeField("DECIMAL(18, 2)", "1.8", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("DECIMAL(20, 11)", "-1.0987654321", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("DATETIME(3)", "2022-06-06 10:22:33", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("TIMESTAMP", "2022-06-06 10:22:33", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("tinytext", null, "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("YEAR", "2022", "utf8", false));
        fieldList.add(MakeFieldFactory.makeField("enum('red','green','yellow')", "red", "utf8", true));
        fieldList.add(MakeFieldFactory.makeField("set(1,2,3)", "2", "utf8", true));
        fieldList.add(MakeFieldFactory.makeField("geometry", null, "utf8", true));
