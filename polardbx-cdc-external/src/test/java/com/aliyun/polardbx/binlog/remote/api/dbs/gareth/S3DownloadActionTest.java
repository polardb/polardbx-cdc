...
public class S3DownloadActionTest {
    @Test
    public void s3download() throws IOException {
        try(MockedStatic<Shell> shellMockedStatic = Mockito.mockStatic(Shell.class)){
            ...
            S3DownloadAction action = new S3DownloadAction(object.toJSONString());
            action.download("/Users/yanfenglin/Downloads/gareth/New_1.txt", "apsaradb/New_1.txt", "/Users/yanfenglin/Downloads/gareth/log");
            String[] cmd = "sudo gareth --engine default --config \"{\\\"job_type\\\":\\\"transfer\\\",\\\"src\\\":{\\\"bucket\\\":\\\"apsaradb\\\",\\\"endpoint\\\":\\\"127.0.0.1\\\",\\\"port\\\":\\\"9000\\\",\\\"sk\\\":\\\"test-fdsasdfda-sk\\\",\\\"ak\\\":\\\"test-fdsasdfda-ak\\\",\\\"type\\\":\\\"s3\\\"},\\\"job\\\":{\\\"decompress\\\":true,\\\"src_path\\\":\\\"apsaradb/New_1.txt\\\",\\\"dest_path\\\":\\\"/Users/yanfenglin/Downloads/gareth/New_1.txt\\\"},\\\"dest\\\":{\\\"type\\\":\\\"file\\\"}}\" --logfile /Users/yanfenglin/Downloads/gareth/log/gareth.log --error2stdout".split(" ");
