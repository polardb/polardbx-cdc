...
public class DescribeTaskStatusRequest {
    ...
    public DescribeTaskStatusResult doRequest() {
        StringBuilder apiBuilder = new StringBuilder();
        apiBuilder.append("/service?");
        Map<String, String> paramMap = new TreeMap<>();
        paramMap.put("Action", "DescribeTaskStatus");
        ...
        String result = HttpHelper.doGet(requestUrl, null, null, false);
        return JSON.parseObject(result, DescribeTaskStatusResult.class);
    }
