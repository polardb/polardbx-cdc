...
@Setter
public class RdsDownloadForRestoreRequest {
    ...
    /**
     * 日志文件ID/批量传参，按逗号分割：12345,2345,3456
     */
    private String ArchiveLogId;
    /**
     * 日志文件下载目录/home/mysql/data/mysql
     */
    private String ArchiveLogLocalFolder;
    /**
     * 需要下载实例的hostinsid
     */
    private Integer HostInsId;
    /**
     * 是否解压/true, false，默认为解压
     */
    ...
    public RdsDownloadForRestoreResult doRequest() {
        StringBuilder apiBuilder = new StringBuilder();
        apiBuilder.append("/service?");
        Map<String, String> paramMap = new TreeMap<>();
        paramMap.put("Action", "RdsDownloadForRestore");
        ...
        return JSON.parseObject(result, RdsDownloadForRestoreResult.class);
    }
