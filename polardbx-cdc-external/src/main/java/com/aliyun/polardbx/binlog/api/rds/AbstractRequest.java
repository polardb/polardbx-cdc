...
/**
 * @author chengjin.lyf on 2018/3/28 下午2:26
 * @since 3.2.6
 */
public abstract class AbstractRequest<T> {

    public static final String DEFAULT_STS_API_DOMAIN;
    public static final String DEFAULT_RDS_API_DOMAIN;
    public static final String DEFAULT_AK;
    ...
    static {
        DEFAULT_STS_API_DOMAIN = getFromEnv("sts_domain", "");
        DEFAULT_RDS_API_DOMAIN = getFromEnv("rds_api", "");
        DEFAULT_AK = getFromEnv("global_ak", "");
        DEFAULT_SK = getFromEnv("global_sk", "");
    }
    ...
    static String getFromEnv(String name, String defaultValue) {
