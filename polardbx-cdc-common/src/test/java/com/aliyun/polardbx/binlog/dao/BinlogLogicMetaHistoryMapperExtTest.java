...
public class BinlogLogicMetaHistoryMapperExtTest extends BaseTest {
    ...
    public void test() {
        ...
        int n = binlogLogicMetaHistoryMapperExtend.softClean("103", 100);
