...
public interface ValidationDiffMapper {
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:50.015+08:00",
        comments = "Source Table: validation_diff")
    BasicColumn[] selectList =
        BasicColumn.columnList(id, stateMachineId, serviceId, taskId, validationTaskId, type, state, srcLogicalDb,
            srcLogicalTable, srcLogicalKeyCol, srcPhyDb, srcPhyTable, srcPhyKeyCol, srcKeyColVal, dstLogicalDb,
            dstLogicalTable, dstLogicalKeyCol, dstKeyColVal, deleted, createTime, updateTime, diff);
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:50.012+08:00",
        comments = "Source Table: validation_diff")
    @SelectProvider(type = SqlProviderAdapter.class, method = "select")
    @ConstructorArgs({
        @Arg(column = "id", javaType = Long.class, jdbcType = JdbcType.BIGINT, id = true),
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:50.016+08:00",
        comments = "Source Table: validation_diff")
