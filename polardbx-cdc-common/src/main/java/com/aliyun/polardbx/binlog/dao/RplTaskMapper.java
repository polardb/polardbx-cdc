...
public interface RplTaskMapper {
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:49.974+08:00",
        comments = "Source Table: rpl_task")
    BasicColumn[] selectList =
        BasicColumn.columnList(id, gmtCreated, gmtModified, gmtHeartbeat, status, serviceId, stateMachineId, type,
            masterHost, masterPort, position, worker, clusterId, extractorConfig, pipelineConfig, applierConfig,
            lastError, statistic, extra);

    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:49.972+08:00",
        comments = "Source Table: rpl_task")
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:49.973+08:00",
        comments = "Source Table: rpl_task")
    @SelectProvider(type = SqlProviderAdapter.class, method = "select")
    @ConstructorArgs({
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-15T14:24:49.975+08:00",
        comments = "Source Table: rpl_task")
