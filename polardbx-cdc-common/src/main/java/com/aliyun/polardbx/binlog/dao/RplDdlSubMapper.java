...
public interface RplDdlSubMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-07-13T15:39:08.955+08:00", comments="Source Table: rpl_ddl_sub")
    BasicColumn[] selectList = BasicColumn.columnList(id, gmtCreated, gmtModified, fsmId, ddlTso, taskId, serviceId, state);
