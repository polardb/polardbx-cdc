...
public class ColumnarNodeInfo {
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2023-09-08T11:47:24.239+08:00",
    ...
    public ColumnarNodeInfo(Long id, Date gmtCreated, Date gmtModified, String clusterId, String containerId, String ip,
                            Integer daemonPort, String availablePorts, Integer status, Long core, Long mem,
                            Date gmtHeartbeat, String latestCursor, String role, String clusterType, String groupName) {
        this.id = id;
