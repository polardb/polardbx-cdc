...
public final class TxnTag extends
        ...
        try {
            ...
            while (!done) {
                ...
                case 18: {
                    ...
                    tokenOneof_ =
                        input.readMessage(com.aliyun.polardbx.binlog.protocol.TxnMergedToken.parser(),
                            extensionRegistry);
                    if (subBuilder != null) {
    ...
    internalGetFieldAccessorTable() {
        return com.aliyun.polardbx.binlog.protocol.TxnStream.internal_static_com_aliyun_polardbx_binlog_protocol_TxnTag_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                com.aliyun.polardbx.binlog.protocol.TxnTag.class,
                com.aliyun.polardbx.binlog.protocol.TxnTag.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!getTokenOneofCase().equals(other.getTokenOneofCase())) {
            return false;
        }
        switch (tokenOneofCase_) {
        case 1:
            if (!getTxnToken()
                .equals(other.getTxnToken())) {
                return false;
            }
            break;
        case 2:
            if (!getTxnMergedToken()
                .equals(other.getTxnMergedToken())) {
                return false;
            }
            break;
        case 0:
    ...
    public static final class Builder extends
        ...
        public Builder mergeFrom(com.aliyun.polardbx.binlog.protocol.TxnTag other) {
            if (other == com.aliyun.polardbx.binlog.protocol.TxnTag.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeTxnToken(com.aliyun.polardbx.binlog.protocol.TxnToken value) {
            if (txnTokenBuilder_ == null) {
                if (tokenOneofCase_ == 1 &&
                    ...
                    tokenOneof_ = com.aliyun.polardbx.binlog.protocol.TxnToken
                        .newBuilder((com.aliyun.polardbx.binlog.protocol.TxnToken) tokenOneof_)
        ...
        public Builder mergeTxnMergedToken(com.aliyun.polardbx.binlog.protocol.TxnMergedToken value) {
            if (txnMergedTokenBuilder_ == null) {
                if (tokenOneofCase_ == 2 &&
                    ...
                    tokenOneof_ = com.aliyun.polardbx.binlog.protocol.TxnMergedToken
                        .newBuilder((com.aliyun.polardbx.binlog.protocol.TxnMergedToken) tokenOneof_)
                        .mergeFrom(value).buildPartial();
                } else {
                    tokenOneof_ = value;
                }
